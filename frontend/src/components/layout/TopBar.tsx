...
const TopBar = ({ onMenuClick, showMenuButton = false, hideSearch = false, title, subtitle }: TopBarProps) => {
  ...
  return (
    <header className={`sticky top-0 z-40 flex h-14 items-center justify-between border-b border-[rgba(59,130,246,0.4)] card-border-color backdrop-blur-xl px-4 lg:px-6 ${theme === "light" ? "bg-white" : "bg-background/80"}`}>
