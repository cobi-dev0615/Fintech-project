...
const FIRECalculator = () => {
  ...
  return (
    <div className="space-y-6 min-w-0">
      <div>
        <h1 className="text-xl sm:text-2xl font-bold text-foreground">Calculadora FIRE</h1>
      ...
      {result && (
        <ChartCard title="Resultado">
          <div className="flex flex-col gap-2">
            <p className="text-sm text-muted-foreground">
              Tempo estimado para atingir 25x seus gastos anuais:
            </p>
